  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta name="theme-color" content="#262d31" />
        ...
        <meta property="og:site_name" content="Chessmate" />
        ...
        {/* Twitter */}
        <meta name="twitter:title" content="Chessmate" />
